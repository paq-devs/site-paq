"use client";
import styles from "./ExperienciasAprendizado.module.css";
...
export default function ExperienciasAprendizado() {
  return ( <div className={styles.container}>teste seção de eventos (experiencias de aprendizagem)</div>
