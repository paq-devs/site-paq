...
import imagemSetaAbaixo from "./setaAbaixo.svg";
import imagemCompartilhar from "./compartilhar.svg";
import "./ConectarETransformar.css";
...
export default function ConectarETransformar() {
  return (
    <div className="container">
      ...
      <VideoConexao />
      <p>
        Além de uma ONG, somos uma <strong>comunidade de aprendizagem.</strong>
      </p>
      <p>
        Somos uma ponte{" "}
        <strong>entre a quebrada e os centros de inovação</strong> e acreditamos
