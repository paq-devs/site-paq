import andreMoraes from "./img/andre-moraes.jpg";
import thiagoCerutti from "./img/thiago-cerutti.jpg";
import pietraRocha from "./img/pietra-rocha-danilevicz.jpg";
import hadjamirisRochaSilva from "./img/hadjamiris-rocha-silva.jpg";
import gabrielaSilva from "./img/gabriela-silva.jpg";
import juliaBandeiraBusch from "./img/julia-bandeira-busch.jpg";
import leonardoMartins from "./img/leonardo-martins.jpg";
import igorRohrigSouza from "./img/igor-rohrig-souza.jpg";
import nicolasPedroso from "./img/nicolas-santos.jpg";
